  ...
  <div class="landing-page">
      ...
      <div class="header-container">
        ...
        <nav class="nav-links">
          ...
          <button class="theme-toggle" @click="cycleTheme"
            ...
            <!-- System -->
            <svg v-if="settingsStore.theme === 'system'" xmlns="http://www.w3.org/2000/svg" width="15" height="15"
            ...
            <!-- Dark -->
            <svg v-else-if="settingsStore.theme === 'dark'" xmlns="http://www.w3.org/2000/svg" width="15" height="15"
              viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
              stroke-linejoin="round">
    ...
    <section class="hero-section">
      <div class="hero-container">
        ...
        <div class="editor-mockup animate-fade-in">
          <div class="mockup-header">
            ...
            <div class="mockup-title font-ui">untitled_log.md</div>
          </div>
    ...
    <section id="features" class="features-section">
      <div class="section-container">
        <h2 class="section-title font-display">Simple, yet highly capable.</h2>
        <div class="features-grid font-ui">
          <!-- Card 1: Local first -->
    ...
    <footer class="footer font-ui">
      <div class="footer-container">
        ...
        <div class="footer-links">
          ...
          <a href="https://github.com/joshuasarmiento/aethernotes/blob/main/CONTRIBUTING.md" target="_blank"
            rel="noopener">Contributing</a>
          <span class="footer-sep">·</span>
          <a href="https://github.com/joshuasarmiento/aethernotes/blob/main/LICENSE" target="_blank" rel="noopener">MIT
            License</a>
        </div>
...
const simulatedLines = ref<SimulatedLine[]>([
  { text: '', type: 'h1', class: 'sim-h1' },
  { text: '', type: 'body', class: 'sim-p placeholder' },
  { text: '', type: 'body', class: 'sim-p' }
]);
  ...
  demoScript.forEach(step => {
    if (step.line !== undefined && step.text !== undefined) {
      ...
      chars.forEach((char, charIdx) => {
        ...
        }, timeAccumulator + charIdx * (step.delay as number));
        timers.push(timer);
      });
      timeAccumulator += chars.length * (step.delay as number) + 400;
    } else if (step.action === 'nextLine') {
      const timer = setTimeout(() => {
        activeLineIdx.value = step.targetLine as number;
        if (simulatedLines.value.length <= (step.targetLine as number)) {
          simulatedLines.value.push({ text: '', type: 'body', class: 'sim-p' });
        }
      }, timeAccumulator);
      timers.push(timer);
      timeAccumulator += 300;
